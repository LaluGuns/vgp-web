...
/**
 * SocialDock - Fixed bottom social bar with magnetic icons
...
export const socialData = [
    {
        name: 'YouTube',
        href: 'https://www.youtube.com/@VirzyGuns',
        icon: (
    ...
    {
        name: 'Instagram',
        href: 'https://www.instagram.com/virzyguns/',
        icon: (
            <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24">
    ...
    {
        name: 'TikTok',
        href: 'https://www.tiktok.com/@virzyguns808',
        icon: (
            <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24">
