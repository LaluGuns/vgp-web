...
export const portals = [
    ...
    },
    {
        ...
        title: 'MASTERCLASS',
        subtitle: 'Producer Education',
        description: 'Practical learning for cleaner decisions, stronger arrangements, and better releases.',
        color: '#93C5FD',
    ...
    },
    {
        ...
        description: 'Production notes, research-backed breakdowns, and VGP release updates.',
        color: '#00D4FF',
        href: '/blog',
        cta: 'READ ARTICLES',
    },
    {
        id: 'about' as const,
        title: 'ABOUT VGP',
        subtitle: 'Founder and Philosophy',
        description: 'Meet Virzy Guns and the 100% Art, 100% Science system behind VGP.',
        color: '#E0E0E0',
        href: '/about',
        cta: 'DISCOVER',
    },
