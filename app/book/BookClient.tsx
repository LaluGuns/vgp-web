                                ...
                                <m.div variants={fadeUp} className="mt-8 grid grid-cols-2 gap-4 border-t border-white/10 pt-6 sm:grid-cols-4">
                                    {features.map((feature) => (
                                        <div key={feature.label}>
                                            ...
                                            <p className="text-xs text-white/55">{feature.detail}</p>
                                        </div>
                                    ))}
                                </m.div>
                            </div>
                        ...
                        >
                            ...
                            <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
                                {chapters.map((chapter) => (
                                    ...
                                    >
                                        <p className="mb-3 text-2xl font-black text-white/10">{chapter.number}</p>
                                        <h3 className="mb-2 text-sm font-bold leading-snug text-white">{chapter.title}</h3>
                                        <p className="text-xs leading-6 text-white/65">{chapter.desc}</p>
                                    </m.div>
                                ))}
                            </div>
                        </m.div>
