...
import { Check, ExternalLink, Mail, Instagram, Sparkles } from 'lucide-react';
                    ...
                    <div className="mx-auto max-w-5xl">
                        <div className="grid gap-10 lg:grid-cols-[0.85fr_1.15fr] lg:items-start">
                            ...
                            <m.div variants={revealUp} initial="hidden" animate="visible" className="space-y-6">
                                ...
                                <div className="rounded-xl border border-amber-500/30 bg-amber-500/[0.08] p-5 space-y-3">
                                    <div className="flex items-center gap-2 text-amber-200 font-semibold text-sm">
                                        <Sparkles className="h-4 w-4 shrink-0" />
                                        <span>Want Exclusive Rights for "{beat.title}"?</span>
                                    </div>
                                    <p className="text-xs text-white/70 leading-5">
                                        Own 100% full exclusive rights and remove this instrumental from the public catalog. Contact Virzy Guns directly via Instagram DM or Email.
                                    </p>
