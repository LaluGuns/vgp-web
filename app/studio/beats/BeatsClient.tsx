                ...
                <div className="max-w-3xl mx-auto relative">
                    ...
                    >
                        ...
                        >
                            ...
                            <span className="block text-white/35">Instrumentals.</span>
                        </h1>
                        <p className="mt-2 text-xs font-semibold uppercase tracking-[0.25em] text-[#FF3CAC]/60 mb-6">100% Art. 100% Science.</p>
                    ...
                    >
                        <GlassCard padding="lg" glow="cyan" className="text-center">
                            ...
                            <button
                                ...
                                disabled
                                aria-disabled="true"
                                className="inline-flex cursor-not-allowed items-center gap-2 px-6 py-3 border border-primary/40 text-primary/70 rounded-xl bg-primary/5 transition-all duration-200"
                            >
                                <span>Exclusive Waitlist Soon</span>
