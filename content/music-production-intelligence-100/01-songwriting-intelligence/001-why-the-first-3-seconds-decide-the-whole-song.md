# 001 - Skip risk starts in the intro
...
Pattern interrupt: phone voice memo waveform beside a handwritten hook line appears before the full headline, with the voice memo pulse marked in cyan and the problem marked in red.

Open loop: The viewer waits to see which decision makes opening hook clearer in the session.

Retention payoff: The payoff is a practical test: Cut the intro until the song still makes sense.

Visual identity: phone voice memo waveform beside a handwritten hook line; motif: voice memo pulse; camera: tight editorial crop over notebook, phone, and piano-roll details; motion: text snaps in on the first beat, then the melody or lyric path draws itself.

Motion plan: 0-3s phone voice memo waveform beside a handwritten hook line appears before the full headline, with the voice memo pulse marked in cyan and the problem marked in red; 3-9s show the symptom; 9-18s map attention and expectation; 18-24s run the move, Start with the strongest sonic identity; 24-30s prove it with Cut the intro until the song still makes sense and close on The first moment carries a promise.
...
Slide 1 thumbnail read: Skip risk
...
Art and taste anchor: Taste is knowing what can be late.
...
Visible text:
- SLIDE 1 | THE HOOK
- [Skip risk starts] in the intro
- The [listener] has no reason to wait yet. The first three seconds trigger a skip-or-stay decision based on predictive coding.
- www.virzyguns.com
- 100% Art. 100% Science.
...
Headline accent: [expectation shapes]
Support accent: [brain builds]
