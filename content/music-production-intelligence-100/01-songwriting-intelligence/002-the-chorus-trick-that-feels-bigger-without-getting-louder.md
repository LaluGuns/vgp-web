# 002 - Make the chorus bigger without volume
...
Pattern interrupt: chorus lyric line under an unchanged volume meter appears before the full headline, with the chorus doorway marked in cyan and the problem marked in red.

Open loop: The viewer waits to see which decision makes chorus contrast clearer in the session.

Retention payoff: The payoff is a practical test: Mute one verse layer and replay the hook.

Visual identity: chorus lyric line under an unchanged volume meter; motif: chorus doorway; camera: tight editorial crop over notebook, phone, and piano-roll details; motion: text snaps in on the first beat, then the melody or lyric path draws itself.

Motion plan: 0-3s chorus lyric line under an unchanged volume meter appears before the full headline, with the chorus doorway marked in cyan and the problem marked in red; 3-9s show the symptom; 9-18s map contrast and expectation; 18-24s run the move, Make the verse narrower before the chorus arrives; 24-30s prove it with Mute one verse layer and replay the hook and close on The chorus feels taller.
...
Slide 1 thumbnail read: Make chorus bigger without

Viral hook: Make the chorus bigger without volume
...
Primary keyword: chorus contrast

Science anchor: contrast and expectation

Art and taste anchor: Size is often a before-and-after illusion.
