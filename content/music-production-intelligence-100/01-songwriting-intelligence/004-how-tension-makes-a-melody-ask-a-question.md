# 004 - A melody needs a question mark
...
Pattern interrupt: piano-roll melody contour bending into a question mark appears before the full headline, with the melody question curve marked in cyan and the problem marked in red.

Open loop: The viewer waits to see which decision makes melodic tension clearer in the session.

Retention payoff: The payoff is a practical test: Sing the phrase with the final note removed.

Visual identity: piano-roll melody contour bending into a question mark; motif: melody question curve; camera: tight editorial crop over notebook, phone, and piano-roll details; motion: text snaps in on the first beat, then the melody or lyric path draws itself.

Motion plan: 0-3s piano-roll melody contour bending into a question mark appears before the full headline, with the melody question curve marked in cyan and the problem marked in red; 3-9s show the symptom; 9-18s map expectation and resolution; 18-24s run the move, Delay the note that feels like home; 24-30s prove it with Sing the phrase with the final note removed and close on The chorus earns its release.
...
Slide 1 thumbnail read: melody needs question mark
...
Art and taste anchor: The best melodic question sounds obvious after it resolves.
