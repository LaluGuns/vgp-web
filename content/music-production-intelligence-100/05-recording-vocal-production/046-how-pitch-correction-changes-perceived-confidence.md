# 046 - Pitch correction changes confidence
...
Pattern interrupt: pitch correction lane bending confidence in small steps appears before the full headline, with the pitch confidence marked in cyan and the problem marked in red.

Open loop: The viewer waits to see which decision makes pitch correction clearer in the session.

Retention payoff: The payoff is a practical test: Slow the retune until the phrase starts breathing again.

Visual identity: pitch correction lane bending confidence in small steps; motif: pitch confidence; camera: close studio crop with mic, vocal lane, and performer detail; motion: vocal waveform breathes while small markers appear on the emotional detail.

Motion plan: 0-3s pitch correction lane bending confidence in small steps appears before the full headline, with the pitch confidence marked in cyan and the problem marked in red; 3-9s show the symptom; 9-18s map pitch perception; 18-24s run the move, Set the correction around the genre and the singer's intent; 24-30s prove it with Slow the retune until the phrase starts breathing again and close on The vocal feels intentional.
...
Slide 1 thumbnail read: Pitch correction changes confidence
...
Visible text:
- SLIDE 1 | THE HOOK
- [Pitch correction changes] confidence
- Pitch correction can make a vocal feel [focused or lifeless].
- www.virzyguns.com
- 100% Art. 100% Science.
...
Support accent: [Aggressive pitch]
...
Support accent: [Listeners associate]
Motion cue: Fast A/B wipe. Red problem detail appears for one beat, then cyan guide line pulls the eye back to the pitch confidence.
Reference line: Refs: Senior 2011 | Bregman 1990
...
Support accent: [Retain micro-pitch]
Motion cue: Vocal waveform breathes while small markers appear on the emotional detail. Keep small labels still.
Reference line: Refs: Senior 2011 | Bregman 1990
...
Headline accent: [retune speed]
Support accent: [pitch correction]
Motion cue: Vocal waveform breathes while small markers appear on the emotional detail. Keep small labels still.
Reference line: Refs: Senior 2011 | Bregman 1990
