# 044 - Doubling works when nobody notices
...
Pattern interrupt: double take ghost lane behind a lead vocal appears before the full headline, with the ghost double marked in cyan and the problem marked in red.

Open loop: The viewer waits to see which decision makes vocal doubling clearer in the session.

Retention payoff: The payoff is a practical test: Mute the double during the chorus.

Visual identity: double take ghost lane behind a lead vocal; motif: ghost double; camera: close studio crop with mic, vocal lane, and performer detail; motion: vocal waveform breathes while small markers appear on the emotional detail.

Motion plan: 0-3s double take ghost lane behind a lead vocal appears before the full headline, with the ghost double marked in cyan and the problem marked in red; 3-9s show the symptom; 9-18s map auditory fusion; 18-24s run the move, Tuck the double until it is felt more than heard; 24-30s prove it with Mute the double during the chorus and close on The hook feels wider.
...
Slide 1 thumbnail read: Doubling works nobody notices
