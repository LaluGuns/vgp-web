# 045 - Perfect vocal comps can kill the human
...
Pattern interrupt: comp lane stitches across several human takes appears before the full headline, with the human comp marked in cyan and the problem marked in red.

Open loop: The viewer waits to see which decision makes vocal comping clearer in the session.

Retention payoff: The payoff is a practical test: Compare the clean comp with the emotional take.

Visual identity: comp lane stitches across several human takes; motif: human comp; camera: close studio crop with mic, vocal lane, and performer detail; motion: vocal waveform breathes while small markers appear on the emotional detail.

Motion plan: 0-3s comp lane stitches across several human takes appears before the full headline, with the human comp marked in cyan and the problem marked in red; 3-9s show the symptom; 9-18s map performance continuity; 18-24s run the move, Keep emotional phrasing even when one note is less perfect; 24-30s prove it with Compare the clean comp with the emotional take and close on The vocal keeps its pulse.
...
Slide 1 thumbnail read: Perfect vocal comps kill
...
Visible text:
- SLIDE 1 | THE HOOK
- Perfect vocal comps can [kill the human]
- A perfect comp can [erase the reason] the take worked.
- www.virzyguns.com
- 100% Art. 100% Science.
...
Headline accent: [Believability over]
Support accent: [resonance]
Motion cue: Fast A/B wipe. Red problem detail appears for one beat, then cyan guide line pulls the eye back to the human comp.
Reference line: Refs: Moore 2012 | Senior 2011
...
Support accent: [Phonetic transitions]
...
Headline accent: [flow in context]
Support accent: [mix]
Motion cue: Use a tap or mute action. The human comp changes visibly.
Reference line: Refs: Moore 2012 | Senior 2011
