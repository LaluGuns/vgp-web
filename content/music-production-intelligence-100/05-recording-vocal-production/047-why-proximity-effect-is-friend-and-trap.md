# 047 - Proximity effect can trap you
...
Pattern interrupt: proximity effect rings building low-mid pressure appears before the full headline, with the proximity trap marked in cyan and the problem marked in red.

Open loop: The viewer waits to see which decision makes proximity effect clearer in the session.

Retention payoff: The payoff is a practical test: Record one line closer and one line farther.

Visual identity: proximity effect rings building low-mid pressure; motif: proximity trap; camera: close studio crop with mic, vocal lane, and performer detail; motion: vocal waveform breathes while small markers appear on the emotional detail.

Motion plan: 0-3s proximity effect rings building low-mid pressure appears before the full headline, with the proximity trap marked in cyan and the problem marked in red; 3-9s show the symptom; 9-18s map microphone proximity effect; 18-24s run the move, Choose distance before EQ surgery; 24-30s prove it with Record one line closer and one line farther and close on The vocal has body without mud.
...
Slide 1 thumbnail read: Proximity effect trap you
...
Visible text:
- SLIDE 1 | THE HOOK
- [Proximity effect] can trap you
- Close vocals get weight, but the [low end can crowd] the mix.
- www.virzyguns.com
- 100% Art. 100% Science.
