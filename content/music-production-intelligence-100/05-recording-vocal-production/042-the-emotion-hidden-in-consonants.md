# 042 - Consonants carry hidden emotion
...
Pattern interrupt: consonant spikes glowing inside a vocal waveform appears before the full headline, with the consonant spark marked in cyan and the problem marked in red.

Open loop: The viewer waits to see which decision makes vocal consonants clearer in the session.

Retention payoff: The payoff is a practical test: Bypass heavy de-essing and listen for lyric edge.

Visual identity: consonant spikes glowing inside a vocal waveform; motif: consonant spark; camera: close studio crop with mic, vocal lane, and performer detail; motion: vocal waveform breathes while small markers appear on the emotional detail.

Motion plan: 0-3s consonant spikes glowing inside a vocal waveform appears before the full headline, with the consonant spark marked in cyan and the problem marked in red; 3-9s show the symptom; 9-18s map speech intelligibility; 18-24s run the move, Protect consonants before smoothing the vocal too much; 24-30s prove it with Bypass heavy de-essing and listen for lyric edge and close on The lyric cuts through.
...
Slide 1 thumbnail read: Consonants carry hidden emotion

Viral hook: Consonants carry hidden emotion
