...
Pattern interrupt: gain-match level scene revealing a smaller loud master appears before the full headline, with the gain-match shrink marked in cyan and the problem marked in red.

Open loop: The viewer waits to see which decision makes loud master clearer in the session.

Retention payoff: The payoff is a practical test: Compare a louder master and a punchier master after gain match.

Visual identity: gain-match level scene revealing a smaller loud master; motif: gain-match shrink; camera: mastering desk crop with meter, waveform, and playback device in one frame; motion: meter needles move first, then the gain-matched waveform tells the truth.

Motion plan: 0-3s gain-match level scene revealing a smaller loud master appears before the full headline, with the gain-match shrink marked in cyan and the problem marked in red; 3-9s show the symptom; 9-18s map loudness normalization; 18-24s run the move, Protect transient contrast before chasing level; 24-30s prove it with Compare a louder master and a punchier master after gain match and close on The punch stays intact.
...
Slide 1 thumbnail read: Loud masters shrink matching
...
Visible text:
- SLIDE 1 | THE HOOK
- Loud masters can shrink after matching
- Squashing your track to sound loud can make it sound tiny on streaming apps.
- www.virzyguns.com
- 100% Art. 100% Science.
