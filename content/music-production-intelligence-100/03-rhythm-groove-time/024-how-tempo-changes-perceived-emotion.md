...
Pattern interrupt: tempo thermometer shifting the emotional color of a loop appears before the full headline, with the tempo heat marked in cyan and the problem marked in red.
Open loop: The viewer waits to see which decision makes tempo emotion clearer in the session.
Retention payoff: The payoff is a practical test: Bounce the hook three BPM slower and faster.
Visual identity: tempo thermometer shifting the emotional color of a loop; motif: tempo heat; camera: top-down rhythm grid with human movement cues around it; motion: timing dots drift by a few pixels while the beat grid stays fixed.
Motion plan: 0-3s tempo thermometer shifting the emotional color of a loop appears before the full headline, with the tempo heat marked in cyan and the problem marked in red; 3-9s show the symptom; 9-18s map arousal and timing; 18-24s run the move, Test tempo before changing the sound palette; 24-30s prove it with Bounce the hook three BPM slower and faster and close on The song finds its pulse.
...
Visible text:
- SLIDE 1 | THE HOOK
- Tempo changes the [emotional temperature]
- A few BPM can [change the entire mood].
- www.virzyguns.com
- 100% Art. 100% Science.
...
Reference line: Refs: MIT OCW 2016 | Huron 2006 | Senior 2011
...
Headline accent: [songs frantic]
Support accent: [track at]
...
Support accent: [Juslin's research]
