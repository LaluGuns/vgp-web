# 084 - References take ego out of the room
...
Pattern interrupt: reference track mirror cooling down an ego decision appears before the full headline, with the ego mirror marked in cyan and the problem marked in red.

Open loop: The viewer waits to see which decision makes reference tracks clearer in the session.

Retention payoff: The payoff is a practical test: Write one sentence after the reference plays.

Visual identity: reference track mirror cooling down an ego decision; motif: ego mirror; camera: producer desk scene with task timer, DAW, and physical notes; motion: messy options fade down until one decision remains active.

Motion plan: 0-3s reference track mirror cooling down an ego decision appears before the full headline, with the ego mirror marked in cyan and the problem marked in red; 3-9s show the symptom; 9-18s map calibration; 18-24s run the move, Level match the reference and listen for one concrete gap; 24-30s prove it with Write one sentence after the reference plays and close on The mix gets less emotional in a bad way.
...
Slide 1 thumbnail read: References take ego out
...
Science anchor: calibration

Art and taste anchor: The reference is there to reset your ears.
