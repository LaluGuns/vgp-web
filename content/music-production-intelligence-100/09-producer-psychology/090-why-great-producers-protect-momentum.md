# 090 - Great producers protect momentum

Content ID: 090

Pillar: Producer psychology

Story structure: 3-part framework

Hook family: Producer confession

Pattern interrupt: momentum checkpoint with bounce button ready appears before the full headline, with the momentum checkpoint marked in cyan and the problem marked in red.

Open loop: The viewer waits to see which decision makes producer momentum clearer in the session.

Retention payoff: The payoff is a practical test: Finish the arrangement pass before opening the mixer.

Visual identity: momentum checkpoint with bounce button ready; motif: momentum checkpoint; camera: producer desk scene with task timer, DAW, and physical notes; motion: messy options fade down until one decision remains active.

Motion plan: 0-3s momentum checkpoint with bounce button ready appears before the full headline, with the momentum checkpoint marked in cyan and the problem marked in red; 3-9s show the symptom; 9-18s map workflow attention; 18-24s run the move, Capture the full idea before micro-editing; 24-30s prove it with Finish the arrangement pass before opening the mixer and close on The session keeps moving.

CTA: Save this before reopening the session tonight.
...
Slide 1 thumbnail read: Great producers protect momentum
...
Science anchor: workflow attention

Art and taste anchor: Momentum is part of the sound.
...
Pillar visual language: Producer psychology: desk state, timer, decision board, reference mirror, plugin overload, reset cue, momentum checkpoint.
...
Headline accent: [track completion]
Support accent: [Review your]
...
Headline accent: [timeline moving]
Support accent: [Prioritize speed]
