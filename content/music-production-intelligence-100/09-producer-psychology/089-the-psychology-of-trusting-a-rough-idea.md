# 089 - Rough ideas need protection
...
Pattern interrupt: rough idea protected under a small glass cover appears before the full headline, with the rough protection marked in cyan and the problem marked in red.

Open loop: The viewer waits to see which decision makes rough idea clearer in the session.

Retention payoff: The payoff is a practical test: Write the reason the loop made you move.

Visual identity: rough idea protected under a small glass cover; motif: rough protection; camera: producer desk scene with task timer, DAW, and physical notes; motion: messy options fade down until one decision remains active.

Motion plan: 0-3s rough idea protected under a small glass cover appears before the full headline, with the rough protection marked in cyan and the problem marked in red; 3-9s show the symptom; 9-18s map creative evaluation; 18-24s run the move, Mark what works before fixing what sounds cheap; 24-30s prove it with Write the reason the loop made you move and close on The record keeps its first pulse.
...
Slide 1 thumbnail read: Rough ideas need protection
...
Science anchor: creative evaluation

Art and taste anchor: Early energy is easy to over-edit.
