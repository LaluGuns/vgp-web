...
Pattern interrupt: attention spotlight moving across a miniature mix stage appears before the full headline, with the attention spotlight marked in cyan and the problem marked in red.

Open loop: The viewer waits to see which decision makes listener attention clearer in the session.

Retention payoff: The payoff is a practical test: Mute the lead and see if the section loses meaning.

Visual identity: attention spotlight moving across a miniature mix stage; motif: attention spotlight; camera: human listening scene mixed with clean psychological diagram overlays; motion: memory traces and attention lights move before the text lands.

Motion plan: 0-3s attention spotlight moving across a miniature mix stage appears before the full headline, with the attention spotlight marked in cyan and the problem marked in red; 3-9s show the symptom; 9-18s map auditory scene analysis; 18-24s run the move, Decide what the ear should follow in each section; 24-30s prove it with Mute the lead and see if the section loses meaning and close on The mix tells a cleaner story.
...
Slide 1 thumbnail read: Attention moves like spotlight
...
Visible text:
- SLIDE 1 | THE HOOK
- [Attention moves] like a spotlight
- A busy [mix] confuses the ear and loses the listener's focus.
- www.virzyguns.com
- 100% Art. 100% Science.
...
Headline accent: [Attention moves]
Support accent: [mix]
...
Headline accent: [sounds]
Support accent: [Auditory grouping]
...
Reference line: Refs: Koelsch 2014 | URL: https://doi 2011 | Type: peer-reviewed neuroscience review 2011 | Year: 2014 2011 | Use: music, emotion, reward, brain response 2011 | Huron 2006 | URL: https://mitpress 2011 | Type: established textbook 2011 | Year: 2006 2011 | Use: expectation, tension, surprise 2011
...
Support accent: [Retain background]
