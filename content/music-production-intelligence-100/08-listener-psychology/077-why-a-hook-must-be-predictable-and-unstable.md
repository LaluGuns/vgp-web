# 077: Hooks need comfort plus instability
...
Pattern interrupt: comfort and instability seesaw under a hook melody appears before the full headline, with the unstable comfort marked in cyan and the problem marked in red.

Open loop: The viewer waits to see which decision makes hook psychology clearer in the session.

Retention payoff: The payoff is a practical test: Sing the hook ending two different ways.

Visual identity: comfort and instability seesaw under a hook melody; motif: unstable comfort; camera: human listening scene mixed with clean psychological diagram overlays; motion: memory traces and attention lights move before the text lands.

Motion plan: 0-3s comfort and instability seesaw under a hook melody appears before the full headline, with the unstable comfort marked in cyan and the problem marked in red; 3-9s show the symptom; 9-18s map prediction and tension; 18-24s run the move, Repeat the core phrase while delaying one resolution; 24-30s prove it with Sing the hook ending two different ways and close on The phrase sticks.
...
Slide 1 thumbnail read: Hooks need comfort plus

Viral hook: Hooks need comfort plus instability
