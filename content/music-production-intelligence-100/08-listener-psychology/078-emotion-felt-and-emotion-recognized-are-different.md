...
Pattern interrupt: felt emotion and named emotion split into two glass lanes appears before the full headline, with the felt vs named marked in cyan and the problem marked in red.

Open loop: The viewer waits to see which decision makes music emotion clearer in the session.

Retention payoff: The payoff is a practical test: Ask if the chorus feels sad, comforting, or heavy.

Visual identity: felt emotion and named emotion split into two glass lanes; motif: felt vs named; camera: human listening scene mixed with clean psychological diagram overlays; motion: memory traces and attention lights move before the text lands.

Motion plan: 0-3s felt emotion and named emotion split into two glass lanes appears before the full headline, with the felt vs named marked in cyan and the problem marked in red; 3-9s show the symptom; 9-18s map perceived and induced emotion; 18-24s run the move, Write for the reaction you want, not the mood label alone; 24-30s prove it with Ask if the chorus feels sad, comforting, or heavy and close on The emotion gets sharper.
...
Slide 1 thumbnail read: Felt emotion named emotion
...
Visible text:
- SLIDE 1 | THE HOOK
- Felt emotion and named [emotion differ]
- A song can describe sadness, but the [groove] is what makes you feel it.
- www.virzyguns.com
- 100% Art. 100% Science.
...
Reference line: Refs: Juslin and Vastfjall 2008 | URL: https://doi 2011 | Type: peer-reviewed music psychology 2011 | Year: 2008 2011 | Use: mechanisms behind musical emotion 2011 | Koelsch 2014 | URL: https://doi 2011 | Type: peer-reviewed neuroscience review 2011 | Year: 2014 2011 | Use: music, emotion, reward, brain response 2011
...
Headline accent: [Groove carries]
