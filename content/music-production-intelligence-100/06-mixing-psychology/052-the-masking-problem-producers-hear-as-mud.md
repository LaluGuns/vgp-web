# 052 - Mud is often masking, not dirt
...
Pattern interrupt: masking heatmap between vocal and synth lanes appears before the full headline, with the masking heat marked in cyan and the problem marked in red.

Open loop: The viewer waits to see which decision makes frequency masking clearer in the session.

Retention payoff: The payoff is a practical test: Pull the pad down a little and check vocal clarity.

Visual identity: masking heatmap between vocal and synth lanes; motif: masking heat; camera: realistic DAW and mixer closeup with one plugin-like panel in focus; motion: A/B wipe toggles between the broken mix and the cleaner decision.

Motion plan: 0-3s masking heatmap between vocal and synth lanes appears before the full headline, with the masking heat marked in cyan and the problem marked in red; 3-9s show the symptom; 9-18s map simultaneous masking; 18-24s run the move, Cut the competing part before boosting the lead; 24-30s prove it with Pull the pad down a little and check vocal clarity and close on The mix opens without pushing level.
...
Slide 1 thumbnail read: masking not dirt
...
Visible text:
- SLIDE 1 | THE HOOK
- Mud is often [masking], not dirt
- Mud often means too [many parts share] the same lane.
- www.virzyguns.com
- 100% Art. 100% Science.
...
Headline accent: [masking]
Support accent: [many parts share]
...
Support accent: [Boosting individual]
...
Support accent: [Auditory masking]
...
Headline accent: [down background]
