...
function FocusHeatmap({ sessions }: { sessions: DbSession[] }) {
  ...
  const [hoveredCell, setHoveredCell] = useState<{ date: Date; minutes: number; x: number; y: number; parentW: number } | null>(null);
  ...
  return (
    <div className="glass-card p-6 relative overflow-visible select-none mt-2">
      ...
      <div className="flex justify-between items-center mb-6">
        ...
        <div className="flex items-center gap-2 text-[9px] font-sans font-semibold uppercase tracking-[0.1em] text-white/40">
