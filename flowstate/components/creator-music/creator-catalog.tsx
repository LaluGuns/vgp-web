              ...
              <div className="flex items-center gap-2">
                ...
                {grantState === "ready" ? (
                  <>
                    ...
                    <a href={certificateHref(item.id, licenseeName)} download title={regional?.downloadPdf ?? (isId ? "Download Sertifikat PDF" : "Download License PDF")} aria-label={`${regional?.downloadPdf ?? "Download License PDF"}: ${item.title}`} className="grid h-9 w-9 place-items-center rounded-full border border-[#00e5ff]/30 bg-[#00e5ff]/10 text-[#00e5ff] transition-colors hover:bg-[#00e5ff]/20">
