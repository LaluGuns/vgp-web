-- Flowstate schema (namespaced with flowstate_ prefix to coexist with vgp_* founder tables)
...
-- Profiles (created lazily by the app on login; no auth.users trigger on this shared project)
