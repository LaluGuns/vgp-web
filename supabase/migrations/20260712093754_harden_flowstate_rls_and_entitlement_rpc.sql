...
create index if not exists idx_fs_licenses_track on public.flowstate_licenses(track_id);
create index if not exists idx_fs_presets_user on public.flowstate_mixer_presets(user_id);
create index if not exists idx_fs_playlist_tracks_track on public.flowstate_playlist_tracks(track_id);
;
