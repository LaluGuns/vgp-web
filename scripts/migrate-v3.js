...
const sql = `
-- Add scheduled_for column to campaigns table for scheduling broadcasts
...
const runMigration = async () => {
    ...
    try {
        ...
        console.log('Connected! Executing schema V3 migration...');
        await client.query(sql);
        console.log('Schema migration V3 completed successfully!');
    } catch (error) {
