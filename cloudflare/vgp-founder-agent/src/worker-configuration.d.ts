/* eslint-disable */
// Generated by Wrangler by running `wrangler types ./src/worker-configuration.d.ts` (hash: db14dacafc42bfce91781c7bbdc5e1e1)
// Runtime types generated with workerd@1.20260730.1 2026-07-29 nodejs_compat
interface __BaseEnv_Env {
	ENVIRONMENT: "staging" | "production" | "development";
	INTERNAL_HMAC_KEY_ID: "staging-v1" | "production-v1" | "local-v1";
	PROPOSAL_MODE: "mock-dry-run";
	MAX_BODY_BYTES: "32768";
	CHIEF_OF_STAFF: DurableObjectNamespace<import("./index").ChiefOfStaff>;
	REPLAY_GUARD: DurableObjectNamespace<import("./index").ReplayNonceGuard>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./index");
		durableNamespaces: "ChiefOfStaff" | "ReplayNonceGuard";
	}
	interface StagingEnv {
		ENVIRONMENT: "staging";
		INTERNAL_HMAC_KEY_ID: "staging-v1";
		PROPOSAL_MODE: "mock-dry-run";
		MAX_BODY_BYTES: "32768";
		CHIEF_OF_STAFF: DurableObjectNamespace<import("./index").ChiefOfStaff>;
		REPLAY_GUARD: DurableObjectNamespace<import("./index").ReplayNonceGuard>;
	...
	interface ProductionEnv {
		...
		INTERNAL_HMAC_KEY_ID: "production-v1";
		PROPOSAL_MODE: "mock-dry-run";
		MAX_BODY_BYTES: "32768";
		CHIEF_OF_STAFF: DurableObjectNamespace<import("./index").ChiefOfStaff>;
		REPLAY_GUARD: DurableObjectNamespace<import("./index").ReplayNonceGuard>;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ENVIRONMENT" | "INTERNAL_HMAC_KEY_ID" | "PROPOSAL_MODE" | "MAX_BODY_BYTES">> {}
}
