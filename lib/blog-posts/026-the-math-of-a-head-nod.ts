...
export const post026: BlogArticle = {
    ...
    excerpt: 'A head nod is not just a reaction. It is a physical pendulum syncing with periodic motion. Learn why over-editing kills the body response.',
    category: 'arrangement-groove',
    publishedAt: '2026-06-05',
    readingTime: 8,
    seo: {
        title: 'The Math of a Head Nod | VGP Studio',
        description: 'Discover the physics of head-nod coordination. Learn how periodic drum cycles sync with motor cortex resonances to create physical groove.',
        keywords: ['head nod groove', 'periodic motion', 'music production', 'beat making', 'rhythm physics', 'drum editing']
    },
    content: `## The track that left you frozen
...
## Why over-editing kills physical response
...
## The science of periodic motion
...
1. Loop the main drum pattern of your track.
2. Mute the master output of your DAW so you hear nothing.
3. Stand up at your desk. Try to tap the kick and snare rhythm on your desk with your fingers.
4. Pay attention to your body. See if your finger taps naturally force your head or shoulders to move.
5. If the tapped rhythm feels awkward or static without the sound, the arrangement is the problem.
6. Adjust the spacing of the snare and kick hits until the physical pattern feels natural to tap.

## The over-editing mistake
...
## Build a consistent periodic cycle
